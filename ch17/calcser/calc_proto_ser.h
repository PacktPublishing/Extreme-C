...
typedef void (*req_cb_t)(void*, struct calc_proto_req_t);
typedef void (*resp_cb_t)(void*, struct calc_proto_resp_t);
typedef void (*error_cb_t)(void*, const int ref_id, const int error_code);

struct calc_proto_ser_t* calc_proto_ser_new();
void calc_proto_ser_delete(struct calc_proto_ser_t* ser);

void calc_proto_ser_ctor(struct calc_proto_ser_t* ser, void*, int ring_buffer_size);
