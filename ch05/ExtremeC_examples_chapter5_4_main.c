// File name: ExtremeC_examples_chapter5_4_main.c
// Description: Main scenario which calls the polymorphic functions
...
#include "ExtremeC_examples_chapter5_4_cat.h"
#include "ExtremeC_examples_chapter5_4_duck.h"
