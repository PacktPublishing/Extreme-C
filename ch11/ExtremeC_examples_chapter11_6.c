// File name: ExtremeC_examples_chapter11_6.c
// Description: Demonstrate a data race between two processes while
//              using the shared memory for manipulating a shared
//              counter.
//
#include <stdio.h>
#include <stdint.h>
