// File name: ExtremeC_examples_chapter11_5.c
...
int main(int argc, char** argv) {
  ...
  if (shm_fd < 0) {
    fprintf(stderr, "ERROR: Failed to open the shared memory: %s\n",
        strerror(errno));
    return 1;
  }
  ...
  char* ptr = (char*)map;
  fprintf(stdout, "The contents of the shared memory object: %s\n", ptr);
