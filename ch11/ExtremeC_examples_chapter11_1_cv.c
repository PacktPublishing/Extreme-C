// File name: ExtremeC_examples_chapter11_1_cv.c
...
// A structure for keeping all the variables related to a shared state
typedef struct {
...
void* thread_body_1(void* arg) {
  // Obtain a pointer to the shared state
  ...
  printf("A\n");
  // Set the flag to TRUE because 'A' is already printed.
  ss->done = TRUE;
