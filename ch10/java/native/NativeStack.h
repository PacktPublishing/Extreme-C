...
#ifndef _Included_com_packt_extreme_c_ch10_ex1_NativeStack
#define _Included_com_packt_extreme_c_ch10_ex1_NativeStack

#define JNI_FUNC(n) Java_com_packt_extreme_1c_ch10_ex1_NativeStack_##n
