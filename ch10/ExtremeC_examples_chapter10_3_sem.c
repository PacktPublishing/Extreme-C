// File name: ExtremeC_examples_chapter10_3_sem.c
// Description: This example uses a binary semaphore to resolve
//              the data race issue observed in the example 10.3.

#include <stdio.h>
#include <stdlib.h>

#include <pthread.h> // The POSIX standard header for using pthread library
#include <semaphore.h> // The semaphores are not exposed through pthread.h

// The main pointer addressing a semaphore object used to synchronize
...
int main(int argc, char** argv) {
  ...
  // we need to initialize the semaphore as a names one using
  // sem_open function.
