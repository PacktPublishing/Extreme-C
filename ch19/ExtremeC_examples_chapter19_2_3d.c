// File name: ExtremeC_examples_chapter19_2_3d.c
// Description: Implement 3d geometry calculations.

#include <math.h>

// We need to include the header file since we want to use the types
// polar_pos_3d_t, cartesian_pos_3d_t, etc and the trigonometry functions
// implemented in another source file.
#include "ExtremeC_examples_chapter19_2_geometry.h"
