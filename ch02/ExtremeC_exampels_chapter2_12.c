// File name: ExtremeC_examples_chapter2_12.c
// Description: Example 2.12
...
int main(int argc, char** argv) {
  char* ptr1 = (char*)malloc(10 * sizeof(char)); // Allocate 10 bytes without intialization
  ...
  char* ptr2 = (char*)calloc(10, sizeof(char)); // Allocation 10 bytes all initalized to zero
